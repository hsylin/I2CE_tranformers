...
public:
    ...
    void computeInterleaved2Learners(int8_t *input_interleaved, int8_t *output_interleaved);
    void computeInterleaved4Learners(int8_t *input_interleaved, int8_t *output_interleaved);
